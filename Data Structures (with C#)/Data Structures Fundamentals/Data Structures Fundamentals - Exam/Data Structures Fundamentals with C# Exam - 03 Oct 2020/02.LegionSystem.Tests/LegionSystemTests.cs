namespace _02.LegionSystem.Tests
{
    ...
    public class LegionSystemTests
    {
        ...
        [Test]
        public void TestCreateÀddsOnlyUniqueEnemies()
        {
            this._legion.Create(this._savedEnemy);
        ...
        [Test]
        public void TestGetByAttackSpeedReturnsNull()
        {
            var arachnoid = new Arachnoid(1005, 200);

            Assert.IsNull(this._legion.GetByAttackSpeed(arachnoid.AttackSpeed));
        }
        ...
        public void TestContainsReturnsFalse()
        {
            ...
            Assert.IsFalse(this._legion.Contains(arachnoid));
        }
        ...
        [Test]
        public void TestGetFastestThrowsException()
        {
        ...
        [Test]
        public void TestGetSlowestThrowsException()
        {
            var legion = new Legion();
        ...
        [Test]
        public void TestShootFastestThrowsException()
        {
            var legion = new Legion();
        ...
        [Test]
        public void TestShootSlowestThrowsException()
        {
            var legion = new Legion();
